...
public class MDPClient {
   ...
   *
   * @param serverUrl
   *          <code>String</code> value for the server address.
   * @throws MalformedURLException
   *           if the URL is malformed.
   */
  public MDPClient(String serverUrl)
      throws MalformedURLException {
  ...
  public String tagText(Vector<String> v) throws XmlRpcException {
    ...
    return (String)this.client.execute("parser.tagText", v);
  }


  public String tagSentence(Vector<String> v) throws XmlRpcException {

    return (String)this.client.execute("parser.tagSentence", v);
  }


  public String parseSentence(Vector<String> v) throws XmlRpcException {

    return (String)this.client.execute("parser.parseSentence", v);
  }


  public String parseText(Vector<String> v) throws XmlRpcException {

    return (String)this.client.execute("parser.parseText", v);
  }
