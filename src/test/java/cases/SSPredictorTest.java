...
public class SSPredictorTest {
	public static void main(String[] args) throws IOException {
		...
		String[] modelFiles = {"temp/ssalpha.txt","temp/m.txt","temp/lc.txt","temp/ne.txt","temp/end.txt",taggerFile};
		...
		(
	//	"Meinen Sie, das ist eine Chance, um einen Konsens im Umgang mit Rechtradikalen zu finden? So gut wie nichts in der Hand."
		inp
		);
